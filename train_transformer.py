...
if __name__ == "__main__":
    ...
    parser.add_argument("--disc-factor", type=float, default=1.0, help="Weighting factor for the Discriminator.")
    parser.add_argument("--l2-loss-factor", type=float, default=1.0, help="Weighting factor for reconstruction loss.")
